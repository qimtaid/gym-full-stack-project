      ...
      <div className="container py-5 py-lg-0 min-vh-100 d-flex align-items-center justify-content-center">
        <div  className="text-center">
          ...
          <div className="mt-4 d-flex flex-wrap justify-content-center gap-4">
            <a
              href="/dashboard"
              className="btn btn-danger text-black px-4 py-2 shadow-sm hover:bg-danger focus:outline-none focus:ring active:bg-danger"
            >
             Go to Dashboard
            </a>
            <a
              href="/about"
              className="btn btn-danger text-black px-4 py-2 shadow-sm hover-text-danger focus:outline-none focus:ring active:text-danger"
            >
              About Us
            </a>
          </div>
